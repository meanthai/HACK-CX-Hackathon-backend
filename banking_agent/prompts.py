...
Vui lòng đưa ra cho người dùng một số gợi ý hoặc các câu hỏi tiềm năng liên quan đến các chủ đề họ đang quan tâm dựa trên dữ liệu hành vi được cung cấp và các chính sách khuyến mãi hiện tại của ngân hàng dưới đây:
...
*Các chính sách khuyến mãi và quà tặng hiện tại từ ngân hàng (chỉ sử dụng nếu có liên quan đến thông tin cá nhân của người dùng): {current_banking_promotional_policies}
